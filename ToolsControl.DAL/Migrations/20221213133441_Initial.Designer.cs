...
namespace ToolsControl.DAL.Migrations
{
    ...
    [Migration("20221213133441_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToolsControl.DAL.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "520d15e3-2dea-4f30-afd6-6a5b18f96c5a",
                            Name = "Worker"
                        },
                        new
                        {
                            Id = new Guid("7510e33a-099f-48d9-8d01-f229db155641"),
                            ConcurrencyStamp = "1d9ac8a3-1cc9-4d2a-9ad8-c4e0129335ef",
                            Name = "Administrator"
                        });
                });

            modelBuilder.Entity("ToolsControl.DAL.Entities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ToolsControl.DAL.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ToolsControl.DAL.Entities.Worker", b =>
                {
                    ...
                    b.HasOne("ToolsControl.DAL.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
